...
<section>
   ...
   <center><img class="img-responsive" src="{{url('public/startuplogin/img/Registration-Successful.png')}}"></center>
    ...
    <a href="{{route('product')}}"> <div class="text-center"><button type="submit" class="b2">Back</button></div>
</section> 
@endif
@if(Session::get('status')==0) 
<section>
    <br><br><br><br>
   <center><img class="img-responsive" src="{{url('public/startuplogin/img/deny.jpg')}}"></center>
    <h1 style="text-align:center;font-size:40px">Sorry ! Your transaction has been failed. </h1>
    <p style="text-align:center;font-size:15px">Try Again Later.</p>
