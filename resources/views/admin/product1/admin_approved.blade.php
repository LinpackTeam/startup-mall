          ...
          @if(count($product)>0)
                        ...
                        <tr>
                           ...
                           <td>{{$products->mrp}}</td>
                            ...
                            <td>
                               <a href="{{route('view-product_admin',$products->product_id)}}" style="width: 30px; padding-left:5px;" class="btn btn-info" style="width: 10px;" style="color: #008000;"><i class="fa fa-eye" style="width: 10px;"></i></a>
