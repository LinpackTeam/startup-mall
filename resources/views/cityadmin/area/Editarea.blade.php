              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('update-area',$area->area_id)}}" method="post" enctype="multipart/form-data">
                      ...
                      <input type="hidden" class="form-control" id="exampleInputName1" name="city_id" value="{{$city->city_id}}">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="cod">
                          <option value="1" @if($area->cod == 1) selected @endif>Yes</option>
                          <option value="0" @if($area->cod == 0) selected @endif>No</option>
                      </select>
                    </div>
