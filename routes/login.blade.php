              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Start-Up  PANEL</h1>
                    @if (count($errors) > 0)
                      @if($errors->any())
                  ...
                  {{csrf_field()}}
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name="cityadmin_email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="cityadmin_pass" id="exampleInputPassword" placeholder="Password">
                    </div>
                    <!-- <div class="form-group">
