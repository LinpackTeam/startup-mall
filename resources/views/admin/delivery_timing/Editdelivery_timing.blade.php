                ...
                <div class="card-body">
                 ...
                 @endif
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="delivery_timing_text" value="{{$delivery_timing->delivery_timing_text}}" id="exampleInputName1">
                    </div>
                  <div class="form-group">
                      <label for="exampleInputName1">Delivery Time Slot</label>
                      <input type="text" class="form-control" name="delivery_time_slot" value="{{$delivery_timing->delivery_time_slot}}" id="exampleInputName1">
                    </div>
