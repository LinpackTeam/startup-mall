...
<nav class="navbar  navbar-dark bg-dark" style="height:54px">
  ...
  <form class="form-inline">
     <a href="{{route('cityadmin-index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" align="right" style="padding: 11px;"><i class="fas fa-download fa-sm text-white-50"></i> City admin Panel</a>
  </form>
</nav>        
 ...
 @foreach($unassignedtodayorder as $todayorders)
  <div class="col-lg-12 col-md-12 col-sm-12" style="padding: 16px; border-bottom: 5px dotted; margin-bottom: 13px;">
    <div class ="col-lg-7 col-md-7 col-sm-7" style="border:1px solid grey; background-color:#f7eeee; float: left;">
        <p style="font-size: 14px;"><span>@if($todayorders->order_type =='Subscribe')Subscription Id @else Buyonce Id @endif: </span> <b><span style="color:black">{{$todayorders->subs_id}} </span></b></p>
    </div>  
    <div class ="col-lg-5 col-md-5 col-sm-5"  style="border:1px solid grey; background-color:#f7eeee; float: left;">
       <p style="font-size: 14px;"><span>User id : </span> <b><span style="color:black">{{$todayorders->user_id}}</span></b></p>
    </div>
    <p>Product : <span style="color:black">{{$todayorders->product_name}}</span></p>
     <p>Order Qty : <span style="color:black">{{$todayorders->order_qty}}</span></p> 
     <p>Price : <span style="color:black">{{$todayorders->price}}</span></p>
     <p>Delivery Date : <span style="color:black">{{$todayorders->delivery_date}}</span></p> 
     <button type="button" style="width:100%" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$todayorders->subs_id}}">Assign</button>
</div>
   <div class="modal fade" id="exampleModal{{$todayorders->subs_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    			 ...
    			 <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect3 " name="delivery_boy_name">
		             ...
		             @endforeach
                      ...
                      <input type="hidden" class="form-control" name="subs_id" value={{$todayorders->subs_id}}>
...
<div class="col-lg-12 col-md-12 col-sm-12" style="padding: 16px; border-bottom: 5px dotted; margin-bottom: 13px;">
    <div class ="col-lg-7 col-md-7 col-sm-7" style="border:1px solid grey; background-color:#f7eeee; float: left;">
        <p style="font-size: 14px;"><span>@if($todayorderss->order_type =='Subscribe')Subscription Id @else Buyonce Id @endif :</span> <b><span style="color:black">{{$todayorderss->subs_id}} </span></b></p>
    </div>  
    <div class ="col-lg-5 col-md-5 col-sm-5"  style="border:1px solid grey; background-color:#f7eeee; float: left;">
       <p style="font-size: 14px;"><span>User id : </span> <b><span style="color:black">{{$todayorderss->user_id}}</span></b></p>
    </div>
    <p>Product : <span style="color:black">{{$todayorderss->product_name}}</span></p>
     <p>Order Qty : <span style="color:black">{{$todayorderss->order_qty}}</span></p> 
     <p>Price : <span style="color:black">{{$todayorderss->price}}</span></p>
     <p>Delivery Date : <span style="color:black">{{$todayorderss->delivery_date}}</span></p> 
     <button type="button" style="width:100%" class="btn btn-danger" data-toggle="modal" data-target="#newexampleModal{{$todayorderss->subs_id}}">Assigned/edit ({{$todayorderss->delivery_boy_name}})</button>
</div>
   <div class="modal fade" id="newexampleModal{{$todayorderss->subs_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    	<div class="modal-dialog" role="document">
    		<div class="modal-content">
    			<div class="modal-header">
    				<h5 class="modal-title" id="exampleModalLabel">Assign Delivery Boy</h5>
    			...
    			<div class="modal-body">
    			 <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect3 " name="delivery_boy_name">
                      ...
                      <input type="hidden" class="form-control" name="subs_id" value="{{$todayorderss->subs_id}}" >
...
<div class="col-lg-12" style="height: 100%;">    
  @foreach($completed_orders as $completed_orders) 
    ...
    <p>Product : <span style="color:black">{{$completed_orders->product_name}}</span></p>
     <p>Order Qty : <span style="color:black">{{$completed_orders->order_qty}}</span></p> 
     <p>Price : <span style="color:black">{{$completed_orders->price}}</span></p>
...
<div id="nextday_unassigned" class="tabcontentnew" style="padding:0px !important;">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12" style="padding: 16px; border-bottom: 5px dotted; margin-bottom: 13px;">
    <div class ="col-lg-7 col-md-7 col-sm-7" style="border:1px solid grey; background-color:#f7eeee; float: left;">
        <p style="font-size: 14px;"><span>@if($nextdayorders->order_type =='Subscribe')Subscription Id @else Buyonce Id @endif : </span> <b><span style="color:black">{{$nextdayorders->subs_id}} </span></b></p>
    </div>  
    <div class ="col-lg-5 col-md-5 col-sm-5"  style="border:1px solid grey; background-color:#f7eeee; float: left;">
       <p style="font-size: 14px;"><span>User id : </span> <b><span style="color:black">{{$nextdayorders->user_id}}</span></b></p>
    </div>
    <p>Product : <span style="color:black">{{$nextdayorders->product_name}}</span></p>
     <p>Order Qty : <span style="color:black">{{$nextdayorders->order_qty}}</span></p> 
     <p>Price : <span style="color:black">{{$nextdayorders->price}}</span></p>
     <p>Delivery Date : <span style="color:black">{{$nextdayorders->delivery_date}}</span></p> 
     <button type="button" style="width:100%" class="btn btn-danger" data-toggle="modal" data-target="#nextexampleModal{{$nextdayorders->subs_id}}"> Assign</button>
</div>
 <div class="modal fade" id="nextexampleModal{{$nextdayorders->subs_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    	<div class="modal-dialog" role="document">
    		<div class="modal-content">
    			<div class="modal-header">
    			...
    			<div class="modal-body">
    			 <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect3 " name="delivery_boy_name">
                      ...
                      <input type="hidden" class="form-control" name="subs_id" value={{$nextdayorders->subs_id}}>
 ...
 @foreach($assignednextdayorder as $nextdayorders)
  ...
  <div class="col-lg-12 col-md-12 col-sm-12" style="padding: 16px; border-bottom: 5px dotted; margin-bottom: 13px;">
    ...
    <p>Product : <span style="color:black">{{$nextdayorders->product_name}}</span></p>
     ...
     <p>Price : <span style="color:black">{{$nextdayorders->price}}</span></p>
     <p>Delivery Date : <span style="color:black">{{$nextdayorders->delivery_date}}</span></p> 
     <button type="button" style="width:100%" class="btn btn-danger" data-toggle="modal" data-target="#nextnewexampleModal{{$nextdayorders->subs_id}}">Assigned/edit  ({{$nextdayorders->delivery_boy_name}})</button>
</div>
 
 
  <div class="modal fade" id="nextnewexampleModal{{$nextdayorders->subs_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    	<div class="modal-dialog" role="document">
    		<div class="modal-content">
    			<div class="modal-header">
    				<h5 class="modal-title" id="exampleModalLabel">Assign Delivery Boy/ Incentive</h5>
