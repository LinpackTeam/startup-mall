      ...
      <div class="table-responsive">
        <table class="table table-bordered" id="example8" width="100%" cellspacing="0">
          ...
          @if(count($product)>0)
              ...
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal1{{$products->id}}">Accept</button>
              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$products->id}}">Reject</button>
							</td>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{route('reject-resource-team', $products->id)}}" class="btn btn-primary">Reject</a>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="exampleModal1{{$products->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				<a href="{{route('accept-resource-team', $products->startup_id)}}" class="btn btn-primary">Accept</a>
			</div>
		</div>
	</div>
</div>
